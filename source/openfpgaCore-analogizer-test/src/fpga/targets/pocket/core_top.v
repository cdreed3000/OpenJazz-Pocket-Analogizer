...
wire [1:0] analog_timing_vid =
    ...
    // V11 compatibility: OpenJazz's current interact.json still encodes its
    // historical "...,Pocket OFF" choices as video-type bit 3 (values 8-F).
    // Honour that bit in addition to the newer dedicated Pocket LCD field.
    wire legacy_pocket_off_vid = analogizer_video_type_vid[3];
    wire pocket_blank_screen =
        ((pocket_lcd_mode_vid == 2'b01) || legacy_pocket_off_vid) &&
        analogizer_ena_vid;
...
openFPGA_Pocket_Analogizer #(
    ...
    .i_rst(~reset_n_analog), // V12: restore normal Analogizer reset
    .i_ena(analogizer_ena_core), // V12: menu-controlled enable
    ...
    .video_clk(analogizer_cart_clk), // V11 menu-controlled 15k/31k clock // DIAG V1: PocketDoom-style 12.288 MHz DAC clock
    .analog_video_type(analogizer_video_type_core), // V12: menu-controlled output type
    .R(fb_pixel_safe[23:16]), // V5 LCD tap
    .G(fb_pixel_safe[15:8]),  // V5 LCD tap
    .B(fb_pixel_safe[7:0]),   // V5 LCD tap
    .Hblank(crt_hblank), // V5 LCD tap
    .Vblank(crt_vblank), // V5 LCD tap
    .BLANKn(crt_blankn), // V5 LCD tap
    .Hsync(HSync), // V5 LCD tap
    .Vsync(VSync), // V5 LCD tap
    .Csync(crt_csync), // V5 LCD tap
...
assign video_hs = vidout_hs;
    ...
    wire analogizer_full_raster_vid = 1'b1; // OS25 ANALOGIZER DIAG V7: feed LCD tap a real 640x480 carrier
...
`endif
        ...
        .analog_timing(analog_timing_vid), // V12: menu-controlled Analogizer timing
        ...
        .analog_fetch_ena(analogizer_ena_core), // V12: follow Analogizer enable
        .analog_pixel_clk(),
